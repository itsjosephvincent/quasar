      ...
      <q-img class="absolute-top" src="~assets/mountains.jpg" style="height: 192px">
        <div class="absolute-bottom bg-transparent">
          <q-avatar size="56px" class="q-mb-sm">
            <img
              src="https://avatars.githubusercontent.com/u/102378862?s=400&u=2c18829735c93c99c711a7c2c6118f19eb30480f&v=4">
          </q-avatar>
          <div class="text-weight-bold">Joseph Vincent Limbaroc</div>
          <div>@itsjosephvincent</div>
        </div>
      </q-img>
    </q-drawer>
